                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pull-right">
                                <a href="{{ route('announcements.create') }}" class="btn btn-success"><i class="fa fa-bullhorn"></i>&nbsp;&nbsp;Make an Announcement</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs" role="tablist" style="background-color: white;">
                                <li role="presentation" class="active">
                                    <a href="#home" aria-controls="home" role="tab" data-toggle="tab">Announcements</a>
                                </li>
                            </ul>
