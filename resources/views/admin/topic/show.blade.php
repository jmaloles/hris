   ...
   <nav class="sidebar">
      <ul class="nav nav-pills nav-stacked col-lg-12 col-md-12 col-sm-12 col-xs-12" style="font-size: 14px;">
         ...
         <li class="nav-item active">
            <a class="nav-link" href="{{ route('training.show', $topic->training_id) }}">
            ...
            <div class="row">
               ...
               <div class="col-lg-4">
                  <div class="panel panel-info">
                     <div class="panel-heading">
                        <h1 class="text-center">{{ count($topic->lessons) }}&nbsp;&nbsp;<small>{{ count($topic->lessons) > 1 ? "Lessons" : "Lesson" }}</small></h1>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4">
                  <div class="panel panel-warning">
                     <div class="panel-heading">
                        <h1 class="text-center">{{ $topic->getFileCountInsideDir() }}&nbsp;&nbsp;<small>{{ $topic->getFileCountInsideDir() > 1 ? "Uploaded Files" : "Uploaded File" }}</small></h1>
                     </div>
                  </div>
               </div>
            </div>
