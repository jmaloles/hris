                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs" role="tablist" style="background-color: white;">
                                ...
                                <li role="presentation"><a href="#interview_record" aria-controls="interview_record" role="tab" data-toggle="tab">Leave Counts</a></li>
                            ...
                            <div class="tab-content" style="background-color: white;padding: 20px;border: #ddd solid 1px;">
                                            ...
                                            <div class="col-lg-6">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="email" class="control-label">{{ $employee->email }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('Position') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="Position" class="control-label">{{ $employee->applicant->job_position }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('sss') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="sss" class="control-label">{{ $employee->sss }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('philhealth') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="philhealth" class="control-label">{{ $employee->philhealth }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('pag_ibig') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="pag_ibig" class="control-label">{{ $employee->pag_ibig }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('nbi_clearance') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="nbi_clearance" class="control-label">{{ $employee->nbi_clearance }}</label>
                                                        </div>
                                                    </div>

                                                    <div class="form-group{{ $errors->has('tin') ? ' has-error' : '' }}">
                                                        <label for="tin" class="col-md-4 control-label">Tax Identification Number (TIN):</label>

                                                        <div class="col-md-6">
                                                            <label id="tin" class="control-label">{{ $employee->tin }}</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="first_name" class="control-label">{{ $employee->applicant->first_name }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('middle_initial') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="middle_initial" class="control-label">{{ $employee->applicant->middle_initial }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="last_name" class="control-label">{{ $employee->applicant->last_name }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="date_of_birth" class="control-label">{{ date('F d, Y', strtotime($employee->applicant->date_of_birth)) }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="age" class="control-label" >{{ $employee->applicant->age }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="email" class="control-label">{{ $employee->applicant->email }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="mobile_number" class="control-label">{{ $employee->applicant->mobile_number }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('home_number') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="home_number" class="control-label">{{ $employee->applicant->home_number }}</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label id="address" class="control-label">{{ $employee->applicant->address }}</label>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="interview_record">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="form-horizontal">

                                                <div class="form-group{{ $errors->has('vl_remaining') ? ' has-error' : '' }}">
                                                    <label for="vl_remaining" class="col-md-4 control-label">Vacation Leave Remaning:</label>
